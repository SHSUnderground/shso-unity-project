...
MUL R3.xyz, R1, fragment.texcoord[3];
MUL R2.xyz, R1, c[1];
MAX R0.w, R0, c[2].x;
MUL R2.xyz, R0.w, R2;
MAD R2.xyz, R2, c[2].y, R3;
MAD result.color.xyz, R1, R0, R2;
MOV result.color.w, fragment.texcoord[1];
END
...
MUL R2.xyz, fragment.texcoord[1], R0.w;
MUL R1.xyz, R1.w, R1;
MUL R0.xyz, R2, R0;
MUL R1.xyz, R1, R2;
...
MUL R1.yzw, fragment.texcoord[1].xxyz, R0.w;
DP3 R0.w, fragment.texcoord[2], c[0];
MAX R0.w, R0, c[2].x;
MUL R3.xyz, R1.yzww, fragment.texcoord[3];
...
MUL R0.w, R1.y, R0;
MUL R1.y, R0.w, R1.w;
MUL R0.xyz, fragment.texcoord[1], R2.w;
MAX R0.w, R1.x, c[1].x;
MUL R0.xyz, R0, c[0];
MUL R0.w, R0, R1.y;
MUL R0.xyz, R0.w, R0;
...
MUL R4.xyz, fragment.texcoord[1], R0.w;
MUL R1.xyz, R1.w, R1;
MUL R1.xyz, R1, c[0].x;
MUL R2.xyz, R2.w, R2;
