...
MAD R0.xyz, R0, fragment.color.primary, -c[2];
...
MAD R1.xyz, R1, fragment.color.primary, -c[0];
...
RSQ R1.x, R1.x;
MAD R0.xyz, R0, fragment.color.primary, -c[1];
...
MAD R1.xyz, R2, fragment.color.primary, -c[0];
LG2 R2.x, R3.x;
LG2 R2.y, R3.y;
LG2 R2.z, R3.z;
ADD R0.xyz, -R2, R0;
