...
cmp_pp r3.xyz, -r1.w, r3, r0
dp3_pp r0.x, t1, c0
mul_pp r5.xyz, r3, t2
mul_pp r4.xyz, r3, c1
max_pp r0.x, r0, c3.y
mul_pp r0.xyz, r0.x, r4
mad_pp r0.xyz, r0, c3.z, r5
...
MUL R2.xyz, R0, R1.w;
ADD R2.w, -R0, c[3].x;
MUL R3.yzw, R0.xxyz, R2.w;
CMP R2.xyz, -R0.w, R3.yzww, R2;
DP3 R1.w, fragment.texcoord[1], c[0];
MAX R1.w, R1, c[3].y;
MUL R1.xyz, R2, R1;
MUL R0.xyz, R0, R0.w;
CMP R0.xyz, -R0.w, R0, R1;
MUL R1.xyz, R2, fragment.texcoord[2];
MUL R2.xyz, R2, c[1];
MUL R1.w, R1, R3.x;
MUL R2.xyz, R1.w, R2;
...
cmp_pp r4.xyz, -r3.w, r4, r0
mul_pp r0.xyz, r3, r3.w
mul_pp r2.xyz, r4, r2
cmp_pp r2.xyz, -r3.w, r2, r0
mul_pp r0.x, r5, c1.z
...
texld r0, t2, s4
mul_pp r0.xyz, r0.w, r0
mul_pp r5.xyz, r0, c1.y
mul_pp r0.xyz, r3.w, r3
mad_pp r3.xyz, r0, c1.y, -r5
mov_sat r0.x, t2.z
