...
//
///////////////////////////////////////////
Shader "Marvel/Base/Self-Illuminated-Tex" {
Properties {
...
dcl_2d s0
dcl_2d s1
def c1, 1.00000000, 8.00000000, 0.00000000, 0
dcl t0.xy
dcl t2.xy
texld r1, t0, s0
texld r0, t2, s1
...
dcl_2d s1
dcl_2d s2
def c1, 1.00000000, 8.00000000, 2.00000000, 0.00000000
dcl t0.xy
dcl t2.xy
dcl t3
texldp r0, t3, s1
...
MAD R0.xy, fragment.texcoord[3], R0.x, c[2].z;
MUL R2, R2, c[1];
MOV result.color.w, c[2].x;
