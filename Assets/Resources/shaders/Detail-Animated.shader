...
//
///////////////////////////////////////////
Shader "Marvel/Base/Detail Animated" {
Properties {
...
Float 3 [_XScrollSpeed]
Float 4 [_YScrollSpeed]
SetTexture 0 [_Detail] 2D
...
Keywords { "DIRECTIONAL" "SHADOWS_OFF" "LIGHTMAP_ON" }
Vector 0 [_Time]
Float 1 [_XScrollSpeed]
Float 2 [_YScrollSpeed]
SetTexture 0 [_Detail] 2D
SetTexture 1 [_MainTex] 2D
...
Float 2 [_XScrollSpeed]
Float 3 [_YScrollSpeed]
SetTexture 0 [_Detail] 2D
SetTexture 1 [_MainTex] 2D
...
MAD result.texcoord[0].zw, vertex.texcoord[0].xyxy, c[7].xyxy, c[7];
