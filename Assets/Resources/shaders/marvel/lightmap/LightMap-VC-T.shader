...
MAD R1.xyz, fragment.color.primary, R0.w, -c[2];
MAD R1.xyz, R1, c[2].w, c[2];
DP3 R0.w, fragment.texcoord[1], c[0];
MUL R3.xyz, R1, fragment.texcoord[2];
MUL R2.xyz, R1, c[1];
MAX R0.w, R0, c[3].x;
MUL R2.xyz, R0.w, R2;
MAD R2.xyz, R2, c[3].y, R3;
...
MAD R2.xyz, fragment.color.primary, R1.w, -c[0];
...
MAD R2.xyz, fragment.color.primary, R0.w, -c[2];
MAD R1.yzw, R2.xxyz, c[2].w, c[2].xxyz;
DP3 R0.w, fragment.texcoord[1], c[0];
MAX R0.w, R0, c[3].x;
MUL R3.xyz, R1.yzww, fragment.texcoord[2];
...
MAD R2.yzw, fragment.color.primary.xxyz, R0.w, -c[0].xxyz;
MAD R2.yzw, R2, c[0].w, c[0].xxyz;
MUL R1.xyz, R1.w, R1;
...
mad r2.xyz, v0, r1.w, -c0
mad r2.xyz, r2, c0.w, c0
mul_pp r1.xyz, r2, r1
mul_pp r3.x, r3, c1.y
mul_pp r0.xyz, r0, c1.x
min_pp r0.xyz, r0, r3.x
mov_pp r0.w, c0
...
RSQ R1.x, R0.x;
MAD R0.xyz, fragment.color.primary, R1.w, -c[1];
...
MAD R0.xyz, fragment.color.primary, R0.w, -c[1];
...
MUL R0.w, R1.y, R0;
MUL R1.y, R0.w, R1.w;
MAD R0.xyz, fragment.color.primary, R2.w, -c[1];
MAD R0.xyz, R0, c[1].w, c[1];
MAX R0.w, R1.x, c[2].x;
MUL R0.xyz, R0, c[0];
MUL R0.w, R0, R1.y;
...
mul_pp r0.x, r0, r1.w
mul_pp r0.x, r0, r2
mad r2.xyz, v0, r0.w, -c1
mad r2.xyz, r2, c1.w, c1
max_pp r1.x, r1, c2.y
mul_pp r2.xyz, r2, c0
mul_pp r0.x, r1, r0
...
TEX R0, fragment.texcoord[0], texture[0], 2D;
MAD R2.xyz, fragment.color.primary, R0.w, -c[0];
MAD R2.xyz, R2, c[0].w, c[0];
MUL R0.xyz, R2, R0;
LG2 R1.x, R1.x;
LG2 R1.z, R1.z;
...
MAD R4.xyz, fragment.color.primary, R0.w, -c[0];
...
mov_sat r4.x, t2.z
mad_pp r0.xyz, r4.x, r1, r0
mad r1.xyz, v0, r2.w, -c0
