Shader "Marvel/Lightmap/Diffuse - Transparent" {
Properties {
...
MUL R1.xyz, R1, R0.w;
ADD R1.xyz, R1, -c[2];
MAD R2.yzw, R1.xxyz, c[2].w, c[2].xxyz;
DP3 R0.w, fragment.texcoord[1], c[0];
MAX R0.w, R0, c[3].x;
MUL R3.xyz, R2.yzww, fragment.texcoord[2];
MUL R1.xyz, R2.yzww, c[1];
MUL R0.w, R0, R2.x;
MUL R1.xyz, R0.w, R1;
MAD R1.xyz, R1, c[3].y, R3;
MAD result.color.xyz, R2.yzww, R0, R1;
MOV result.color.w, c[2];
END
...
texld r1, r1, s2
texld r0, t3, s3
mul_pp r0.xyz, r3, r2.w
add r0.xyz, r0, -c1
mad r2.xyz, r0, c1.w, c1
dp3_pp r0.x, t2, t2
rsq_pp r0.x, r0.x
mul_pp r0.xyz, r0.x, t2
dp3_pp r0.x, t1, r0
