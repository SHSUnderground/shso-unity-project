...
//
///////////////////////////////////////////
Shader "Marvel/Base/Self-Illuminated-Tex - Transparent" {
Properties {
...
MUL R1, R1, c[0];
ADD R2.x, -R1.w, c[2];
MUL_SAT R2.xyz, R1, R2.x;
ADD R2.xyz, R2, -c[1];
MUL_SAT R1.xyz, R1, R1.w;
MAD R2.xyz, R2, c[1].w, c[1];
MUL R0.xyz, R0.w, R0;
MUL R1.xyz, R1, c[1].w;
MUL R0.xyz, R0, R2;
...
MUL R0, R0, c[2];
ADD R1.y, -R0.w, c[4];
MUL_SAT R2.xyz, R0, R1.y;
ADD R2.xyz, R2, -c[3];
MAD R1.yzw, R2.xxyz, c[3].w, c[3].xxyz;
...
MUL R0, R0, c[0];
ADD R2.y, -R0.w, c[2].x;
MUL_SAT R2.yzw, R0.xxyz, R2.y;
MUL_SAT R0.xyz, R0, R0.w;
ADD R2.yzw, R2, -c[1].xxyz;
MUL R1.xyz, R1.w, R1;
MAD R2.yzw, R2, c[1].w, c[1].xxyz;
MUL R0.xyz, R0, c[1].w;
MUL R0.w, R2.x, c[2].z;
MUL R1.xyz, R1, c[2].y;
MIN R1.xyz, R1, R0.w;
...
mul r1, r1, c0
add_pp r3.x, -r1.w, c2
mul_pp_sat r3.xyz, r1, r3.x
add r3.xyz, r3, -c1
mul_pp_sat r1.xyz, r1, r1.w
mul_pp r2.xyz, r2.w, r2
mad r3.xyz, r3, c1.w, c1
mul_pp r0.x, r0, c2.z
...
mul r2, r0, c1
add_pp r0.x, -r2.w, c3
mul_pp_sat r2.xyz, r2, r0.x
dp3_pp r0.x, t2, t2
add r2.xyz, r2, -c2
rsq_pp r0.x, r0.x
mul_pp r0.xyz, r0.x, t2
dp3_pp r0.x, t1, r0
mad r2.xyz, r2, c2.w, c2
mul_pp r2.xyz, r2, c0
max_pp r0.x, r0, c3.y
mul_pp r0.x, r0, r1
...
mul r2, r0, c1
add_pp r0.x, -r2.w, c3
mul_pp_sat r0.xyz, r2, r0.x
add r0.xyz, r0, -c2
mad r1.xyz, r0, c2.w, c2
mov_pp r0.xyz, t2
dp3_pp r0.x, t1, r0
mul_pp r1.xyz, r1, c0
max_pp r0.x, r0, c3.y
...
texld r2, t0, s0
mul_pp r0.xyz, r0.w, r0
mul_pp r4.xyz, r0, c2.y
mul_pp r0.xyz, r1.w, r1
mad_pp r1.xyz, r0, c2.y, -r4
mov_sat r0.x, t2.z
mul r2, r2, c0
