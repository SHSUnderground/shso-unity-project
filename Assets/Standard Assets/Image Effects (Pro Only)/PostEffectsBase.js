...
class PostEffectsBase extends MonoBehaviour {	
	...
	function CheckResources () : boolean {
		Debug.Log ("CheckResources () for " + this.ToString() + " should be overwritten.");
		return isSupported;
	}
	...
	function ReportAutoDisable () {
		Debug.Log ("The image effect " + this.ToString() + " has been disabled as it's not supported on the current platform.");
	}
