...
public class SHSStartupWaitWindow : SHSWaitWindow
{
	...
	public override bool InitializeResources(bool reload)
	{
		...
		loadingBg.TextureSource = "GUI/loading/background/" + CspUtils.halloweenPathSuffix + randomBackgroundNumber.ToString();
		...
		progressMiddle.TextureSource = "GUI/loading/progressbar/loading_screen_loading_bar_middle" + CspUtils.halloweenSuffix;
		progressMiddle.Id = "loading bar";
		progressWindow.Add(progressMiddle);
		progressLeftCap = new GUIImage();
		progressLeftCap.TextureSource = "GUI/loading/progressbar/loading_screen_loading_bar_left" + CspUtils.halloweenSuffix;
		...
		progressRightCap.TextureSource = "GUI/loading/progressbar/loading_screen_loading_bar_right" + CspUtils.halloweenSuffix;
		...
		heroBgd.TextureSource = "GUI/loading/characters/" + CspUtils.halloweenPathSuffix + randomBackgroundNumber.ToString();
		Add(heroBgd);
