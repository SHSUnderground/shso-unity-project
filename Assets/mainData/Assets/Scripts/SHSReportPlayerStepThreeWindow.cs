...
public class SHSReportPlayerStepThreeWindow : GUIWindow
{
	private enum ReportReasonEnum
	{
		BadWords,
		BadSquadName,
		Rude,
	...
	public SHSReportPlayerStepThreeWindow()
	{
		...
		gUIToggleButton.Label.Text = "#rap_step_three_profanity";
		...
		gUIToggleButton.Tag = ReportReasonEnum.BadWords;
		reasonButtonList.AddButton(gUIToggleButton);
		gUIToggleButton = new GUIToggleButton();
		gUIToggleButton.Label.Text = "#rap_step_three_sharinginfo";
		gUIToggleButton.Label.SetupText(GUIFontManager.SupportedFontEnum.Komica, 16, new Color(26f / 85f, 32f / 85f, 109f / 255f), TextAnchor.UpperLeft);
		gUIToggleButton.ButtonStyleInfo = new SHSButtonStyleInfo("gameworld_bundle|options_radio_button");
		gUIToggleButton.SetButtonSize(new Vector2(64f, 64f));
		gUIToggleButton.Spacing = 60f;
		...
		gUIToggleButton.Tag = ReportReasonEnum.PersonalInfo;
		reasonButtonList.AddButton(gUIToggleButton);
		gUIToggleButton = new GUIToggleButton();
		gUIToggleButton.Label.Text = "#rap_step_three_rudeormean";
		gUIToggleButton.Label.SetupText(GUIFontManager.SupportedFontEnum.Komica, 16, new Color(26f / 85f, 32f / 85f, 109f / 255f), TextAnchor.UpperLeft);
		gUIToggleButton.ButtonStyleInfo = new SHSButtonStyleInfo("gameworld_bundle|options_radio_button");
		gUIToggleButton.SetButtonSize(new Vector2(64f, 64f));
		gUIToggleButton.Spacing = 60f;
		...
		gUIToggleButton.Tag = ReportReasonEnum.Rude;
		reasonButtonList.AddButton(gUIToggleButton);
		gUIToggleButton = new GUIToggleButton();
		gUIToggleButton.Label.Text = "#rap_step_three_badname";
		gUIToggleButton.Label.SetupText(GUIFontManager.SupportedFontEnum.Komica, 16, new Color(26f / 85f, 32f / 85f, 109f / 255f), TextAnchor.UpperLeft);
		gUIToggleButton.ButtonStyleInfo = new SHSButtonStyleInfo("gameworld_bundle|options_radio_button");
		gUIToggleButton.SetButtonSize(new Vector2(64f, 64f));
		gUIToggleButton.Spacing = 60f;
		...
		gUIToggleButton.Tag = ReportReasonEnum.BadSquadName;
		reasonButtonList.AddButton(gUIToggleButton);
	...
	private void yesButton_Click(GUIControl sender, GUIClickEvent EventData)
	{
		...
		sHSReportPlayerDialogWindow.reportCause = reasonButtonList.SelectedButton.Text;
		switch ((int)reasonButtonList.SelectedButton.Tag)
		{
		case 0:
			sHSReportPlayerDialogWindow.ReportStepCompleted("StepThreeBWWindow");
			break;
		case 3:
			sHSReportPlayerDialogWindow.ReportStepCompleted("StepThreePIWindow");
			break;
		case 2:
			sHSReportPlayerDialogWindow.ReportStepCompleted("StepThreeRUWindow");
			break;
		case 1:
			sHSReportPlayerDialogWindow.reportSubCause = "Bad Squad Name";
	...
	{
		messageLabel.Text = string.Format(AppShell.Instance.stringTable["#rap_report_reason_query"], ((SHSReportPlayerDialogWindow)parent).reportedPlayerName);
		base.OnShow();
	}
}
