public class SidekickUpgradeCollection : ShsCollectionBase<GenericCollectionItem>
{
	protected const string ELEMENT_NAME = "item";

	protected const string KEY_NAME = "type";

	public SidekickUpgradeCollection()
	{
		collectionElementName = "item";
		keyName = "type";
	}

	public SidekickUpgradeCollection(DataWarehouse xmlData)
		: this()
	{
