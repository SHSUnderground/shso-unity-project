public class GUIDialogNoButton : GUIButton
{
	public GUIDialogNoButton()
	{
		Click += GUIDialogNoButton_Click;
		Text = "#gui_no";
	}

	private void GUIDialogNoButton_Click(GUIControl sender, GUIClickEvent EventData)
	{
