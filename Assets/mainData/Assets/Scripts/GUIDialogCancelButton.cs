public class GUIDialogCancelButton : GUIButton
{
	public GUIDialogCancelButton()
	{
		Click += GUIDialogCancelButton_Click;
		Text = "#gui_cancel";
	}

	private void GUIDialogCancelButton_Click(GUIControl sender, GUIClickEvent EventData)
	{
		GUIDialogWindow gUIDialogWindow = FindParentDialog();
		if (gUIDialogWindow != null)
		{
			gUIDialogWindow.OnCancel();
		}
		else
		{
