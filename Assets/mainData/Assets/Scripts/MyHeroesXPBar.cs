...
public class MyHeroesXPBar : GUISimpleControlWindow
{
	...
	public MyHeroesXPBar()
	{
		...
		GUIImage gUIImage2 = GUIControl.CreateControlAbsolute<GUIImage>(new Vector2(63f, 53f), new Vector2(1f, -1f) + b);
		...
		gUIImage3.TextureSource = "mysquadgadget_bundle|mshs_mysquad_heroes_xpbar_left";
		Add(gUIImage3);
		...
		Add(_barCap);
		_barText = GUIControl.CreateControlAbsolute<GUIStrokeTextLabel>(Vector2.zero, new Vector2(60f, 17f) + b);
