...
public class CraftingWindowPrimeContainer : GUISimpleControlWindow
{
	...
	private CraftingWindow _parent;

	public CraftingWindowPrimeContainer(CraftingWindow parent)
	{
		_parent = parent;
