...
public class GenericCollectionItem : ShsCollectionItem
{
	private string type;
	...
	public GenericCollectionItem(DataWarehouse xmlData)
	{
		InitializeFromData(xmlData);
	}

	public GenericCollectionItem(string type, int quantity)
	{
		this.type = type;
