...
public class SHSInventoryHQButton : GUIAnimatedButton
{
	...
	public SHSInventoryHQButton(SHSInventoryAnimatedWindow headWindow, string ItemId, string IconSource, DragDropInfo.CollectionType CollectionId, string CollectionResetString, Func<bool> DragPermitted)
	{
