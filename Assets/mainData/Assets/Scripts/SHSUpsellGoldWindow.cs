...
public class SHSUpsellGoldWindow : GUIDialogWindow
{
	...
	public SHSUpsellGoldWindow()
	{
		...
		titleLabel.Text = "#UPSELL_GOLD_TITLE";
		...
		sellBullet1.Text = "#UPSELL_GOLD_BULLET_1";
		Add(sellBullet1);
		...
		sellBullet2.Text = "#UPSELL_GOLD_BULLET_2";
		...
		sellBullet3.Text = "#UPSELL_GOLD_BULLET_3";
		...
		Add(option3Button);
		backupButton = GUIControl.CreateControlFrameCentered<GUIButton>(new Vector2(256f, 256f), new Vector2(0f, 71f));
		backupButton.StyleInfo = new SHSButtonStyleInfo("mysquadgadget_bundle|L_mshs_mysquad_heroes_button_buynow");
		...
		iconBoy.SetPositionAndSize(77f, 115f, 160f, 160f);
		iconBoy.TextureSource = "mysquadgadget_bundle|challenge_reward_icons_42";
		Add(iconBoy);
