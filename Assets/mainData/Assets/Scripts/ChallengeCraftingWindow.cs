...
public class ChallengeCraftingWindow : SHSGadget.GadgetCenterWindow
{
	private const int _blueprintBaseX = 20;

	private const int _blueprintBaseY = 15;
	...
	private int _blueprintCurrY = 15;
	...
	private List<ChallengeCraftingPrimeContainer> _primeContainers = new List<ChallengeCraftingPrimeContainer>();
	...
	private int _baseContentX = 350;

	private int _baseContentY = 100;
	...
	public ChallengeCraftingWindow()
	{
		...
		_tabButtonGoodies.SetPositionAndSize(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(num2, num), new Vector2(38f, 38f), AutoSizeTypeEnum.Absolute, AutoSizeTypeEnum.Absolute);
		...
		Add(_tabButtonGoodies);
		_tabImageGoodies = new GUIImage();
		_tabImageGoodies.SetSize(50f, 50f);
		_tabImageGoodies.SetPosition(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(num2 - 5, num - 5));
		_tabImageGoodies.TextureSource = "mysquadgadget_bundle|item_type_goodies_highlight";
		Add(_tabImageGoodies);
		_tabButtonSidekicks = new GUIButton();
		_tabButtonSidekicks.SetPositionAndSize(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(num2 + num3, num), new Vector2(38f, 38f), AutoSizeTypeEnum.Absolute, AutoSizeTypeEnum.Absolute);
		...
		Add(_tabButtonSidekicks);
		_tabImageSidekicks = new GUIImage();
		_tabImageSidekicks.SetSize(50f, 50f);
		_tabImageSidekicks.SetPosition(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(num2 + num3 - 5, num - 5));
		_tabImageSidekicks.TextureSource = "mysquadgadget_bundle|item_type_sidekicks_highlight";
		Add(_tabImageSidekicks);
		_tabButtonParts = new GUIButton();
		_tabButtonParts.SetPositionAndSize(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(num2 + num3 * 2, num), new Vector2(38f, 38f), AutoSizeTypeEnum.Absolute, AutoSizeTypeEnum.Absolute);
		...
		_tabImageParts.SetPosition(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(num2 + num3 * 2 - 5, num - 5));
		...
		_blueprintScrollPaneMask.SetSize(279f, 401f);
		_blueprintScrollPaneMask.SetPosition(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(5f, 143f));
		Add(_blueprintScrollPaneMask);
		...
		_blueprintScrollPaneSlider.SetSize(40f, 400f);
		_blueprintScrollPaneSlider.SetPosition(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(285f, 135f));
		Add(_blueprintScrollPaneSlider);
		...
		for (int j = 0; j < 6; j++)
		{
			ChallengeCraftingPrimeContainer challengeCraftingPrimeContainer = new ChallengeCraftingPrimeContainer(this);
			challengeCraftingPrimeContainer.SetPosition(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(_baseContentX + 395 - j * 77, _baseContentY + 206));
			challengeCraftingPrimeContainer.IsVisible = false;
			Add(challengeCraftingPrimeContainer);
			_primeContainers.Add(challengeCraftingPrimeContainer);
		}
		...
		Add(_masterCraftButtonDisabled);
	...
	private void changeRecipeList(string recipeListName)
	{
		if (!(currentRecipeList == recipeListName))
		{
			...
			blueprints.Sort(new CCBlueprintSorter());
	...
	private void addBlueprint(Blueprint blueprint)
	{
		...
		gUISimpleControlWindow.SetPositionAndSize(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(_blueprintCurrX, _blueprintCurrY), new Vector2(250f, 45f), AutoSizeTypeEnum.Absolute, AutoSizeTypeEnum.Absolute);
		CCBlueprintButton cCBlueprintButton = new CCBlueprintButton();
		cCBlueprintButton.SetPositionAndSize(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(0f, 0f), new Vector2(250f, 45f), AutoSizeTypeEnum.Absolute, AutoSizeTypeEnum.Absolute);
		cCBlueprintButton.StyleInfo = new SHSButtonStyleInfo("mysquadgadget_bundle|green_button", SHSButtonStyleInfo.SupportedStatesEnum.Normal | SHSButtonStyleInfo.SupportedStatesEnum.Highlight);
		cCBlueprintButton.ToolTip = new NamedToolTipInfo(AppShell.Instance.stringTable.GetString(blueprint.name));
		cCBlueprintButton.HitTestSize = new Vector2(1f, 1f);
		cCBlueprintButton.HitTestType = HitTestTypeEnum.Circular;
		cCBlueprintButton.Click += selectBlueprint;
		cCBlueprintButton.blueprintID = blueprint.id;
		gUISimpleControlWindow.Add(cCBlueprintButton);
		...
		gUIStrokeTextLabel.SetPositionAndSize(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(22f, -3f), new Vector2(220f, 45f), AutoSizeTypeEnum.Absolute, AutoSizeTypeEnum.Absolute);
		...
		_blueprintScrollPane.Add(gUISimpleControlWindow);
	...
	protected void craftMasterDisabled(GUIControl sender, GUIClickEvent EventData)
	{
		...
		if (flag)
		{
			...
			gUILabel.SetPositionAndSize(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(5f, 3f), new Vector2(530f, 130f), AutoSizeTypeEnum.Absolute, AutoSizeTypeEnum.Absolute);
	...
	{
		if (sender is CCBlueprintButton)
		{
			selectBlueprintByID((sender as CCBlueprintButton).blueprintID);
		}
		else
		{
	...
	public GUISimpleControlWindow createSingleCraftButtonUI(Blueprint blueprint)
	{
		...
		if (flag)
		{
			CCCraftBlueprintButton cCCraftBlueprintButton = GUIControl.CreateControlFrameCentered<CCCraftBlueprintButton>(new Vector2(134f, 72f), new Vector2(0f, 0f));
			cCCraftBlueprintButton.blueprintID = blueprint.id;
			cCCraftBlueprintButton.SetPosition(DockingAlignmentEnum.TopLeft, AnchorAlignmentEnum.TopLeft, OffsetType.Absolute, new Vector2(0f, 0f));
			cCCraftBlueprintButton.StyleInfo = new SHSButtonStyleInfo("mysquadgadget_bundle|craft_item_button", SHSButtonStyleInfo.SupportedStatesEnum.Normal | SHSButtonStyleInfo.SupportedStatesEnum.Highlight);
			gUISimpleControlWindow.Add(cCCraftBlueprintButton);
			cCCraftBlueprintButton.ToolTip = new NamedToolTipInfo(@string, new Vector2(50f, 0f));
			cCCraftBlueprintButton.Click += craftBlueprint;
		}
		else
		{
			GUIButton gUIButton = new GUIButton();
	...
	{
		if (sender is CCCraftBlueprintButton)
		{
			if (!craftLocked)
			{
				AppShell.Instance.StartCoroutine(ToggleIconLocks());
				int blueprintID = (sender as CCCraftBlueprintButton).blueprintID;
		...
		{
			CspUtils.DebugLog("Got craftBlueprint from a control that isn't a CCCraftBlueprintButton button?");
		}
	}
